...
| `fairing_solid` | `registered_not_productized` | `registered_future_route` | `gmsh_closed_solid_volume` | `blocked_until_su2_handoff` | `not_default` | `baseline_gmsh_backend_boundary_recovery` |
