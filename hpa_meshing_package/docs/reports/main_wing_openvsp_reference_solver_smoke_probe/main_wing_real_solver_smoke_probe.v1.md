...
- history_path: `/Volumes/Samsung SSD/hpa-mdo/hpa_meshing_package/.tmp/runs/main_wing_openvsp_reference_su2_handoff_probe/artifacts/su2/alpha_0_real_main_wing_openvsp_reference_probe/history.csv`
- solver_log_path: `/Volumes/Samsung SSD/hpa-mdo/hpa_meshing_package/.tmp/runs/main_wing_openvsp_reference_su2_handoff_probe/artifacts/su2/alpha_0_real_main_wing_openvsp_reference_probe/solver.log`
- convergence_gate_path: `hpa_meshing_package/docs/reports/main_wing_openvsp_reference_solver_smoke_probe/artifacts/convergence_gate.v1.json`
- error: `None`
