    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "MARKER_FAR= ( farfield )",
            f"FREESTREAM_TURBULENCEINTENSITY= {float(solver.get('freestream_turbulence_intensity', 0.01)):.6g}",
            f"FREESTREAM_TURB2LAMVISCRATIO= {float(solver.get('freestream_turb2lam_visc_ratio', 3.0)):.6g}",
