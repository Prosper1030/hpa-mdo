...
def test_route_readiness_keeps_shell_v4_bl_as_promotion_only():
    ...
    assert main_wing.su2_status == "blocked_until_su2_handoff"
    ...
    assert "main_wing_su2_handoff_not_materialized" in main_wing.blocking_reasons
...
def test_route_readiness_marks_fairing_solid_mesh_handoff_smoke_as_available_not_productized():
    ...
    assert "fairing_su2_handoff_artifact_missing" in fairing_solid.blocking_reasons
