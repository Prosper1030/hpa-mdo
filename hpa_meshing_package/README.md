...
vertex-tolerance checks. This is partial metadata progress only; the next gate
is a projected or sampled PCurve builder with explicit vertex/orientation
validation, not mesh handoff.

### 35. Write the main wing mesh-handoff smoke
...
2. prototype projected/sampled side-aware station PCurve builder with vertex/orientation gate before any mesh handoff or solver-budget work
