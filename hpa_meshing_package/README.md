...
### 36. Write the main wing mesh-handoff smoke
...
2. move station-seam repair upstream to side-aware section parametrization or export PCurve metadata generation before any mesh handoff or solver-budget work
