...
### 31. Write the main wing mesh-handoff smoke
...
2. run station BRep/PCurve validation on the side-aware OpenCSM candidate before any mesh handoff or solver-budget work
