...
The carbon tube RFQ pack is ready for vendor screening conversations, not order placement or drawing release.

## What Is Controlled For RFQ

- Station convention: positive half-wing y from centerline/root, mirrored to both sides.
- Structural basis: `16.500 m` half-span with `3.000 m` max transport panels.
- Splice stations: `3 / 6 / 9 / 12 / 15 m` per half-wing.
- Release rib language: `0.30 m` physical rib station basis, `121` full-wing stations.
