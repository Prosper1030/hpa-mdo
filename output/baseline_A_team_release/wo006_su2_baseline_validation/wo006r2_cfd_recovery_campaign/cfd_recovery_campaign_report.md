...
Verdict: `wo006r2_current_geometry_adapter_blocker_isolated`
...
- `attempt_01_replay_old_mesh_native_bl_template`: `Exception`; evidence `PLC point x=0.827965 y=-12.5391 z=1.22456; section bracket 4-5 (dae31->cst_tip_nsga2_g05_child_0032_70ef8136); crosses_airfoil_family=True`; next `localize_current_go_surface_panel_topology_near_plc_station_bracket_without_changing_external_shape`
- `attempt_02_current_go_bl_coarser_quality_probe`: `Exception`; evidence `PLC point x=0.825985 y=-12.5893 z=1.23679; section bracket 4-5 (dae31->cst_tip_nsga2_g05_child_0032_70ef8136); crosses_airfoil_family=True`; next `localize_current_go_surface_panel_topology_near_plc_station_bracket_without_changing_external_shape`
- `attempt_03_current_go_high_mesh_no_bl_solver_control`: `Exception`; evidence `PLC point x=1.00786 y=-7.46727 z=0.398846; section bracket 2-3 (dae31->dae31); crosses_airfoil_family=False`; next `localize_current_go_surface_panel_topology_near_plc_station_bracket_without_changing_external_shape`
