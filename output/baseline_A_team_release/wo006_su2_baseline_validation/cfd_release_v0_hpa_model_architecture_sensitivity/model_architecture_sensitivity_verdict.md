...
| SST Tu0.5 L=0.001c | 50 rows; insufficient window | 0.022740 | 0.007694 | 0.030434 | 1.1625 | total drops about 0.0028 mean, mainly viscous/turbulence state |
...
| LM r2 conservative/upwind | 50 rows; insufficient window | 0.022179 | 0.008688 | 0.030866 | 1.1607 | no omega bounding in first 50 iterations; best LM setup tried |
| pimple SST | invalid | - | - | - | - | process exited without advancing to a force history |

Values are diagnostic means over the available rows. None of these sensitivity
rows has the required 100-row force/CmPitch window.
