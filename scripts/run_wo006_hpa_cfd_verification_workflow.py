...
def local_refinement_zone_rows() -> list[dict[str, str]]:
    return [
        ...
        {
            "zone_id": "possible_low_re_separation_region",
            "target_spacing": "extra upper-surface resolution from LE through aft suction recovery",
            "growth_rate_target": "<=1.20",
            "coarse_to_medium_ratio": "4/3 linear",
            "medium_to_fine_ratio": "5/4 linear",
            "scaling_rule": "preserve the same chordwise band and refine within it at each grid level",
            "why_hpa_specific": "At Re roughly 2.9e5-5.7e5, laminar bubble or transition location can dominate profile drag.",
        },
        {
            "zone_id": "farfield",
