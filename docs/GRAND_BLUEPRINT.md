...
> **文件性質**：長期藍圖 — 定義專案從求解器核心到全自動化設計 App 的五階段演進路線。這不是日常入口；如果你想知道「現在該看哪裡、先做什麼」，請先看 [README.md](../README.md)、[docs/README.md](README.md)、[docs/NOW_NEXT_BLUEPRINT.md](NOW_NEXT_BLUEPRINT.md)。
> **維護者**：總工程師 + AI 架構師  
> **建立日期**：2026-04-09  
> **最後更新**：2026-04-17
...
- **目前正式工程主線**：dual-beam production / inverse design / decision producer。
...
| Phase I-B — M-HF1/2/3 | ✅ | Gmsh runner + CalculiX static + BUCKLE |
| Phase I-B — M-VSP Phase 1 | ✅ | 通用 VSP 抽幾何 + analyze_vsp.py CLI |
