...
- 初步結論：
  ...
  - Mac `structural_check` 經過 `feat: 強化 Mac hifi structural spot-check 診斷輸出` 後，已具備更好的 comparability / issue-category 診斷能力；但目前 basket 裡還沒有一份 fresh representative JSON run，可作為正式可比案例。
