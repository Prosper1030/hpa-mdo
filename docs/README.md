...
| `scripts/current_pathfinder_spar_splice_design.py` | 3 m 翼板 spar splice design | 需要知道 5 joints/half-wing 設計、3.85 kg 全翼展質量、inboard spigot 1.02 mm、3 m 限制鎖定的人 |
...
| `scripts/current_pathfinder_spar_splice_design.py` | 3 m transport spar splice design | 5 joints per half-wing at y=3/6/9/12/15 m; all pass; 3.85 kg full-wing; inboard wall 1.02 mm (auto-upsized); 3 m panel limit locked; 13 tests |
