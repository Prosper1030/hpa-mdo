...
- Engineering read: R27 cleared marker ownership, but R28 showed the repaired
  ...
  transition unit now proves that contract before applying it to the real wing.
